...
<div class="updatepwd">
    <form action="/student/SetNewPassWord" method="POST">
        <div class="input_form">
            <h1>初次登录,请修改密码!</h1>
            <input type="password" name="newPassWord"  placeholder="请输入密码" class="fpwd">
            <div class="error"></div>
            <input type="password" name="newPassword2"  placeholder="请再次输入密码" class="spwd">
        </div>
...
<script>
    window.sessionStorage.setItem("Sno","${Login_user.getId()}");
    if(!$){//后台
        $(".func li span").hide();
    }
</script>
